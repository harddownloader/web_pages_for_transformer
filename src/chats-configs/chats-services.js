...
const servicesDialog2 = [
  ...
  {
    from: "app",
    text: "Если я неправильно вас понял, или в моем ответе недостаточно иноформации и вам нужен специалист, напишите в ответ слово «специалист»",
    second_text: "",
    descr: "",
    icon: "",
    options: false,
...
const servicesDialog4 = [
  {
    from: "app",
    text: "Готов отвечать на Выши вопросы 😊",
    second_text: "",
    descr: "",
    icon: "",
    options: false,
  ...
  {
    from: "app",
    text: "Для отправки уведомления «Позвони мне» наберите в телефоне команду:<br> *144*7XXXXXXXXXX# , где Х - номер абонента. В этом случае он получит SMS с просьбой перезвонить вам. Команда работает только для российских номеров.",
    second_text: "",
    descr: "",
    icon: "",
    options: false,
  ...
  {
    from: "app",
    text: "Если вдруг что-то не получилось, или я неправильно понял вопрос, напишите в ответ «специалист» и я переведу вас в режим живого общения.",
    second_text: "",
    descr: "",
    icon: "",
    options: false,
