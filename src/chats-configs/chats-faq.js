...
const faqDialog3 = [
  ...
  {
    'from': 'app',
    'text': 'У нас работает сразу несколько психологов. Информацию об их терапевтической практике, графиках работы, контактах, а также запись на прием можно найти <span class="blueText">тут</span>.',
    'second_text': '',
    'descr': '',
    'icon': '',
    'options': false,
