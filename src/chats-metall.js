...
const metallDialogs2 = [
  ...
  {
    'from': 'app',
    'text': 'Благодарю, я готов ответить на Ваши вопросы относительно выбранного товара.<br>Ваш вопрос был о стоимости данного товара.<br>На складе в Москве стоимость товара Арматура в бунтах / профиль 10 / Класс A240 / ГОСТ 2 при условии самовывоза составляет 30 000 руб.<br>Остались ли у Вас вопросы по данному товару?',
    'second_text': '',
    'descr': '',
    'icon': '',
    'options': true,
