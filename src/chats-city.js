...
const cityDialog2 = [
  {
    'from': 'app',
    'text': 'Добрый день!<br>Готов консультировать по вопросам:<br>Определение статуса проблемы ЖКХ (водоснабжение, работа лифтов, отопление, поставка электроэнергии)<br>Поиск и отображение статуса проекта Городского бюджета.',
    'second_text': '',
    'descr': '',
    'icon': '',
    'options': false,
  ...
  {
    'from': 'app',
    'text': 'Раздел ЖКХ: 1.Вопросы в произвольной форме. 2. Ответы на уточняющие вопросы. 3.Статус и плановые сроки решения проблемы.',
    'second_text': '',
    'descr': '',
    'icon': '',
    'options': false,
  ...
  {
    'from': 'app',
    'text': 'Указанная улица : • проспект Правды',
    'second_text': '',
    'descr': '',
    'icon': '',
    'options': false,
